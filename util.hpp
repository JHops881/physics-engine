...
void set_uniform_vec3(GLuint shader, const char* uniform_name, glm::vec3 value);

void set_uniform_float(GLuint shader, const char* uniform_name, GLfloat value);

void set_uniform_mat4(GLuint shader, const char* uniform_name, glm::mat4 value);

void set_uniform_mat3(GLuint shader, const char* uniform_name, glm::mat3 value);
}